...
func (ac *AccountCreate) SetUserId(u uint32) *AccountCreate {
...
func (ac *AccountCreate) SetUserID(id uint32) *AccountCreate {
...
func (ac *AccountCreate) AddFieldIDs(ids ...uint32) *AccountCreate {
...
func (ac *AccountCreate) check() error {
	if _, ok := ac.mutation.UserId(); !ok {
		return &ValidationError{Name: "userId", err: errors.New(`store: missing required field "Account.userId"`)}
	}
	if _, ok := ac.mutation.IsActive(); !ok {
		return &ValidationError{Name: "isActive", err: errors.New(`store: missing required field "Account.isActive"`)}
	}
	if _, ok := ac.mutation.IsBlocked(); !ok {
		return &ValidationError{Name: "isBlocked", err: errors.New(`store: missing required field "Account.isBlocked"`)}
	}
	if _, ok := ac.mutation.UserID(); !ok {
		return &ValidationError{Name: "user", err: errors.New(`store: missing required edge "Account.user"`)}
	}
	return nil
}
