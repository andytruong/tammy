...
func (uec *UserEmailCreate) SetID(u uint32) *UserEmailCreate {
	uec.mutation.SetID(u)
	return uec
}

// SetUserID sets the "user" edge to the User entity by ID.
func (uec *UserEmailCreate) SetUserID(id uint32) *UserEmailCreate {
	uec.mutation.SetUserID(id)
	return uec
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (uec *UserEmailCreate) SetNillableUserID(id *uint32) *UserEmailCreate {
	if id != nil {
