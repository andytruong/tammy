...
func (plc *PortalLegalCreate) SetID(u uint32) *PortalLegalCreate {
	plc.mutation.SetID(u)
	return plc
}

// SetPortalID sets the "portal" edge to the Portal entity by ID.
func (plc *PortalLegalCreate) SetPortalID(id uint32) *PortalLegalCreate {
...
func (plc *PortalLegalCreate) check() error {
	if _, ok := plc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`store: missing required field "PortalLegal.createdAt"`)}
	}
	if _, ok := plc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`store: missing required field "PortalLegal.updatedAt"`)}
	}
	if _, ok := plc.mutation.PrivacyPolicy(); !ok {
		return &ValidationError{Name: "privacyPolicy", err: errors.New(`store: missing required field "PortalLegal.privacyPolicy"`)}
	}
	if _, ok := plc.mutation.TermOfService(); !ok {
		return &ValidationError{Name: "termOfService", err: errors.New(`store: missing required field "PortalLegal.termOfService"`)}
	}
	if _, ok := plc.mutation.Copyright(); !ok {
		return &ValidationError{Name: "copyright", err: errors.New(`store: missing required field "PortalLegal.copyright"`)}
	}
	if _, ok := plc.mutation.OnlineTrainingAgreement(); !ok {
		return &ValidationError{Name: "onlineTrainingAgreement", err: errors.New(`store: missing required field "PortalLegal.onlineTrainingAgreement"`)}
	}
	if _, ok := plc.mutation.PortalID(); !ok {
		return &ValidationError{Name: "portal", err: errors.New(`store: missing required edge "PortalLegal.portal"`)}
	}
	return nil
}
