...
func ID(id uint32) predicate.UserEmail {
...
func IDEQ(id uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
...
func IDIn(ids ...uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
...
func IDGTE(id uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
...
func IDLT(id uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
...
func IDLTE(id uint32) predicate.UserEmail {
	return predicate.UserEmail(func(s *sql.Selector) {
