...
func (afq *AccountFieldQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (afq *AccountFieldQuery) FirstIDX(ctx context.Context) uint32 {
...
func (afq *AccountFieldQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (afq *AccountFieldQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (afq *AccountFieldQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (afq *AccountFieldQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := afq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (afq *AccountFieldQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AccountField, error) {
	...
	if query := afq.withAccount; query != nil {
		...
		nodeids := make(map[uint32][]*AccountField)
		for i := range nodes {
