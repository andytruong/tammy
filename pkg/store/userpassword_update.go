...
func (upu *UserPasswordUpdate) SetUserId(u uint32) *UserPasswordUpdate {
...
func (upu *UserPasswordUpdate) AddUserId(u int32) *UserPasswordUpdate {
...
func (upu *UserPasswordUpdate) SetUserID(id uint32) *UserPasswordUpdate {
...
func (upu *UserPasswordUpdate) check() error {
	if _, ok := upu.mutation.UserID(); upu.mutation.UserCleared() && !ok {
		return errors.New(`store: clearing a required unique edge "UserPassword.user"`)
	}
	return nil
}
...
// SetUserId sets the "userId" field.
func (upuo *UserPasswordUpdateOne) SetUserId(u uint32) *UserPasswordUpdateOne {
...
// AddUserId adds u to the "userId" field.
func (upuo *UserPasswordUpdateOne) AddUserId(u int32) *UserPasswordUpdateOne {
...
// SetUserID sets the "user" edge to the User entity by ID.
func (upuo *UserPasswordUpdateOne) SetUserID(id uint32) *UserPasswordUpdateOne {
...
func (upuo *UserPasswordUpdateOne) sqlSave(ctx context.Context) (_node *UserPassword, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`store: missing "UserPassword.id" for update`)}
	}
