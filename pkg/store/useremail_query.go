...
func (ueq *UserEmailQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (ueq *UserEmailQuery) FirstIDX(ctx context.Context) uint32 {
...
func (ueq *UserEmailQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (ueq *UserEmailQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (ueq *UserEmailQuery) IDs(ctx context.Context) ([]uint32, error) {
	var ids []uint32
...
func (ueq *UserEmailQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := ueq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (ueq *UserEmailQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UserEmail, error) {
	...
	if query := ueq.withUser; query != nil {
		...
		nodeids := make(map[uint32][]*UserEmail)
		for i := range nodes {
