...
func ID(id uint32) predicate.UserPassword {
...
func IDEQ(id uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func IDIn(ids ...uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func IDNotIn(ids ...uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
		v := make([]interface{}, len(ids))
		for i := range v {
			v[i] = ids[i]
...
func IDGT(id uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func IDGTE(id uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func IDLT(id uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func IDLTE(id uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func UserId(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func UserIdEQ(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldUserId), v))
	})
}
...
func UserIdNEQ(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func UserIdIn(vs ...uint32) predicate.UserPassword {
...
func UserIdNotIn(vs ...uint32) predicate.UserPassword {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func UserIdGT(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func UserIdGTE(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func UserIdLT(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
...
func UserIdLTE(v uint32) predicate.UserPassword {
	return predicate.UserPassword(func(s *sql.Selector) {
