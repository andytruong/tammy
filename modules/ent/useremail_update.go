...
func (ueu *UserEmailUpdate) SetUserID(id int) *UserEmailUpdate {
	ueu.mutation.SetUserID(id)
	return ueu
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (ueu *UserEmailUpdate) SetNillableUserID(id *int) *UserEmailUpdate {
	if id != nil {
...
// SetUserID sets the "user" edge to the User entity by ID.
func (ueuo *UserEmailUpdateOne) SetUserID(id int) *UserEmailUpdateOne {
	ueuo.mutation.SetUserID(id)
	return ueuo
}

// SetNillableUserID sets the "user" edge to the User entity by ID if the given value is not nil.
func (ueuo *UserEmailUpdateOne) SetNillableUserID(id *int) *UserEmailUpdateOne {
	if id != nil {
