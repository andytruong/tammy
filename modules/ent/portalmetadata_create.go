...
func (pmc *PortalMetadataCreate) SetID(i int) *PortalMetadataCreate {
	pmc.mutation.SetID(i)
	return pmc
}

// SetPortalID sets the "portal" edge to the Portal entity by ID.
func (pmc *PortalMetadataCreate) SetPortalID(id int) *PortalMetadataCreate {
...
func (pmc *PortalMetadataCreate) check() error {
	if _, ok := pmc.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`ent: missing required field "PortalMetadata.createdAt"`)}
	}
	if _, ok := pmc.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`ent: missing required field "PortalMetadata.updatedAt"`)}
	}
	if _, ok := pmc.mutation.Kind(); !ok {
		return &ValidationError{Name: "kind", err: errors.New(`ent: missing required field "PortalMetadata.kind"`)}
	}
	...
	if _, ok := pmc.mutation.Lifecycle(); !ok {
		return &ValidationError{Name: "lifecycle", err: errors.New(`ent: missing required field "PortalMetadata.lifecycle"`)}
	}
	...
	if _, ok := pmc.mutation.PortalID(); !ok {
		return &ValidationError{Name: "portal", err: errors.New(`ent: missing required edge "PortalMetadata.portal"`)}
	}
	return nil
}
