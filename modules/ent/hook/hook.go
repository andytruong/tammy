...
type AccountFieldFunc func(context.Context, *ent.AccountFieldMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f AccountFieldFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.AccountFieldMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.AccountFieldMutation", m)
	}
	return f(ctx, mv)
}
...
type PortalLegalFunc func(context.Context, *ent.PortalLegalMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PortalLegalFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PortalLegalMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PortalLegalMutation", m)
	}
	return f(ctx, mv)
}
...
type PortalMetadataFunc func(context.Context, *ent.PortalMetadataMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PortalMetadataFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.PortalMetadataMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PortalMetadataMutation", m)
	}
	return f(ctx, mv)
}
...
func (f UserPasswordFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	mv, ok := m.(*ent.UserPasswordMutation)
	if !ok {
