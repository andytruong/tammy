...
// UpdateOneID returns an update builder for the given id.
func (c *AccountFieldClient) UpdateOneID(id int) *AccountFieldUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *AccountFieldClient) DeleteOneID(id int) *AccountFieldDeleteOne {
...
func (c *AccountFieldClient) Get(ctx context.Context, id int) (*AccountField, error) {
	return c.Query().Where(accountfield.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AccountFieldClient) GetX(ctx context.Context, id int) *AccountField {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *PortalLegalClient) UpdateOneID(id int) *PortalLegalUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *PortalLegalClient) DeleteOneID(id int) *PortalLegalDeleteOne {
...
func (c *PortalLegalClient) Get(ctx context.Context, id int) (*PortalLegal, error) {
	return c.Query().Where(portallegal.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PortalLegalClient) GetX(ctx context.Context, id int) *PortalLegal {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// UpdateOneID returns an update builder for the given id.
func (c *PortalMetadataClient) UpdateOneID(id int) *PortalMetadataUpdateOne {
...
// DeleteOne returns a builder for deleting the given entity by its id.
func (c *PortalMetadataClient) DeleteOneID(id int) *PortalMetadataDeleteOne {
...
func (c *PortalMetadataClient) Get(ctx context.Context, id int) (*PortalMetadata, error) {
	return c.Query().Where(portalmetadata.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PortalMetadataClient) GetX(ctx context.Context, id int) *PortalMetadata {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
